...
import com.systemevent.sessionbean.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private com.systemevent.sessionbean.ProveedorFacade ejbFacade;
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Proveedor) {
                ...
                return getStringKey(o.getCodigoProveedor());
            } else {
