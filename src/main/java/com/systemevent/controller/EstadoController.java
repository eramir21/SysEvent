...
import com.systemevent.dao.EstadoFacade;
...
//    ArrayList<SelectItem> lst = new ArrayList<>();;
    private com.systemevent.dao.EstadoFacade ejbFacade;
...
//       
//
//        for(Estado estado : ejbFacade.DamelosEstados(idPais)){
//            SelectItem s = new SelectItem(estado.getCodigoEstado(), estado.getNombre());
//            lst.add(s);
//            
//        }
//    
    ...
    public static class EstadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estado) {
                ...
                return getStringKey(o.getCodigoEstado());
            } else {
