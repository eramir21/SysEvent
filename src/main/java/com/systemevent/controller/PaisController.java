...
import com.systemevent.dao.PaisFacade;
...
public class PaisController implements Serializable {
    ...
    @EJB
    private com.systemevent.dao.PaisFacade ejbFacade;
    private List<Pais> items = null;
    private Pais selected;
    
//    @ManagedProperty(value = "#{estadoController}")
//    private EstadoController estadoControler = new EstadoController();
//
//        public void obtenerInformacion(){
//        estadoControler.cargarEstados(1);
//    }
//    
//    
//    public EstadoController getEstadoControler() {
//        return estadoControler;
//    }
//
//    public void setEstadoControler(EstadoController estadoControler) {
//        this.estadoControler = estadoControler;
//    }
    ...
    public static class PaisControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pais) {
                Pais o = (Pais) object;
                return getStringKey(o.getCodigoPais());
            } else {
